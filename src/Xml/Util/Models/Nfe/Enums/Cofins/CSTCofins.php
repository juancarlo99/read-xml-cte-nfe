...
namespace Xml\Util\Models\Nfe\Enums\Cofins;
...
class CSTCofins
{
    ...
    */
     ...
     */
    const OPERACAO_AQUISICAO_SUBSTITUICAO_TRIBUTARIA = '75';
     ...
     */
     ...
     const DESCRICOES = [
        ...
        self::OPERACAO_AQUISICAO_SUBSTITUICAO_TRIBUTARIA => 'Operação de Aquisição por Substituição Tributária',
